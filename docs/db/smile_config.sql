...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 72 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (23, 61, 'smile-sys-dev.yml', 'DEFAULT_GROUP', '', 'spring:\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource #springboot2.x之后默认\r\n    # serverTimezone=GMT%2B8 默认北京时区 useSSL=false 测试不用服务器的验证证书生产需要打开配置\r\n    url: jdbc:mysql://127.0.0.1:3306/smile?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8&useSSL=false\r\n    username: root\r\n    password: root\r\n    # 8.0之后用cj\r\n    driver-class-name: com.mysql.cj.jdbc.Driver\r\n    hikari:\r\n      #必须设置属性  maximum-pool-size  max-lifetime https://blog.csdn.net/michael_728/article/details/106914946\r\n      #连接池名字\r\n      pool-name: adminHikerPool\r\n      #最小空闲连接 此属性控制 HikariCP 尝试在池中维护的最小空闲连接数。 如果空闲连接低于此值并且池中的总连接数小于 maximumPoolSize，\r\n      #则 HikariCP 将尽最大努力快速有效地添加其他连接。 但是，为了获得最高性能和对峰值需求的响应，\r\n      #我们建议不要设置此值，而是允许 HikariCP 充当固定大小的连接池。 默认值：与 maximumPoolSize 相同 （一般配置和maximumPoolSize相同）\r\n      minimum-idle: 10\r\n      #此属性控制允许池到达的最大大小，包括空闲和正在使用的连接。 基本上，此值将确定数据库后端的最大实际连接数。\r\n      #对此的合理值最好由您的执行环境决定。 当池达到此大小，并且没有可用的空闲连接时，对 getConnection() 的调用将在超时前阻塞最多\r\n      #connectionTimeout 毫秒。 请阅读有关游泳池尺寸的信息。 默认值：10\r\n      maximum-pool-size: 10\r\n      #空闲连接存活最大时间，此属性控制允许连接在池中空闲的最长时间。 此设置仅在 minimumIdle 定义为小于maximumPoolSize 时适用。 一旦池达到 minimumIdle 连接，\r\n      #空闲连接将不会退出。 连接是否空闲退出的最大变化为 +30 秒，平均变化为 +15 秒。 在此超时之前，连接永远不会被空闲。\r\n      #值为 0 表示永远不会从池中删除空闲连接。 允许的最小值为 10000 毫秒（10秒）。 默认值：600000（10分钟） 一般不适用\r\n      idle-timeout: 600000\r\n      #此属性控制从池返回的连接的默认自动提交行为,默认值：true\r\n      auto-commit: true\r\n      #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟 此属性控制池中连接的最长生命周期。 使用中的连接永远不会退役，\r\n      #只有当它关闭时才会被删除。 在逐个连接的基础上，应用轻微的负衰减以避免池中的大量灭绝。 我们强烈建议设置此值，它应比任何数据库\r\n      #或基础结构强加的连接时间限制短几秒。 值 0 表示没有最大生命周期（无限生命周期），当然主题是 idleTimeout 设置。 默认值：1800000（30分钟）\r\n      max-lifetime: 1800000\r\n      #数据库连接超时时间  此属性控制客户端（即您）等待池中连接的最大毫秒数。 如果在没有连接可用的情况下超过此时间，则将抛出 SQLException。\r\n      #最低可接受的连接超时为 250 毫秒。 默认值：30000（30秒）\r\n      connection-timeout: 30000\r\n  jackson:\r\n    default-property-inclusion: ALWAYS\r\n    \r\nsmile:\r\n  sys:\r\n    #配置白名单路径,专供admin模块服务\r\n    ignore:\r\n      check: \"1\"\r\n      urls:\r\n        - \"/actuator/**\"\r\n        - \"/doc.html\"\r\n        - \"/webjars/**\"\r\n        - \"/swagger-resources/**\"\r\n        - \"/v2/api-docs\"\r\n        - \"/favicon.ico\"\r\n        - \"/user/**\"\r\nserver:\r\n  port: 8110  \r\n#启用knife4j增强模式\r\nknife4j:\r\n  enable: true\r\n  #生产模式屏蔽, true将禁止访问API在线文档, false可以看到文档, 密码失效\r\n  production: false\r\n  basic:\r\n    enable: true\r\n    username: root\r\n    password: root\r\nmybatis-plus:\r\n  configuration:\r\n    # 这个配置会将执行的sql打印出来，在开发或测试的时候可以用，不能输出到文件,假如需要输出到日志文件中那么 https://www.jb51.net/article/239936.htm\r\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl', 'e44eec8518e4eebdc5c8e8ee27d500b8', '2010-05-05 00:00:00', '2022-12-27 17:36:54', NULL, '192.168.56.1', 'U', '764f9c7a-1874-4c91-985b-0678754a8208');
INSERT INTO `his_config_info` VALUES (23, 62, 'smile-sys-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource #springboot2.x之后默认\n    # serverTimezone=GMT%2B8 默认北京时区 useSSL=false 测试不用服务器的验证证书生产需要打开配置\n    url: jdbc:mysql://192.168.56.10:3306/smile_sys?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8&useSSL=false\n    username: root\n    password: 1qaz2wsx@!\n    # 8.0之后用cj\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    hikari:\n      #必须设置属性  maximum-pool-size  max-lifetime https://blog.csdn.net/michael_728/article/details/106914946\n      #连接池名字\n      pool-name: adminHikerPool\n      #最小空闲连接 此属性控制 HikariCP 尝试在池中维护的最小空闲连接数。 如果空闲连接低于此值并且池中的总连接数小于 maximumPoolSize，\n      #则 HikariCP 将尽最大努力快速有效地添加其他连接。 但是，为了获得最高性能和对峰值需求的响应，\n      #我们建议不要设置此值，而是允许 HikariCP 充当固定大小的连接池。 默认值：与 maximumPoolSize 相同 （一般配置和maximumPoolSize相同）\n      minimum-idle: 10\n      #此属性控制允许池到达的最大大小，包括空闲和正在使用的连接。 基本上，此值将确定数据库后端的最大实际连接数。\n      #对此的合理值最好由您的执行环境决定。 当池达到此大小，并且没有可用的空闲连接时，对 getConnection() 的调用将在超时前阻塞最多\n      #connectionTimeout 毫秒。 请阅读有关游泳池尺寸的信息。 默认值：10\n      maximum-pool-size: 10\n      #空闲连接存活最大时间，此属性控制允许连接在池中空闲的最长时间。 此设置仅在 minimumIdle 定义为小于maximumPoolSize 时适用。 一旦池达到 minimumIdle 连接，\n      #空闲连接将不会退出。 连接是否空闲退出的最大变化为 +30 秒，平均变化为 +15 秒。 在此超时之前，连接永远不会被空闲。\n      #值为 0 表示永远不会从池中删除空闲连接。 允许的最小值为 10000 毫秒（10秒）。 默认值：600000（10分钟） 一般不适用\n      idle-timeout: 600000\n      #此属性控制从池返回的连接的默认自动提交行为,默认值：true\n      auto-commit: true\n      #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟 此属性控制池中连接的最长生命周期。 使用中的连接永远不会退役，\n      #只有当它关闭时才会被删除。 在逐个连接的基础上，应用轻微的负衰减以避免池中的大量灭绝。 我们强烈建议设置此值，它应比任何数据库\n      #或基础结构强加的连接时间限制短几秒。 值 0 表示没有最大生命周期（无限生命周期），当然主题是 idleTimeout 设置。 默认值：1800000（30分钟）\n      max-lifetime: 1800000\n      #数据库连接超时时间  此属性控制客户端（即您）等待池中连接的最大毫秒数。 如果在没有连接可用的情况下超过此时间，则将抛出 SQLException。\n      #最低可接受的连接超时为 250 毫秒。 默认值：30000（30秒）\n      connection-timeout: 30000\n  jackson:\n    default-property-inclusion: ALWAYS\n    \nsmile:\n  sys:\n    #配置白名单路径,专供admin模块服务\n    ignore:\n      check: \"1\"\n      urls:\n        - \"/actuator/**\"\n        - \"/doc.html\"\n        - \"/webjars/**\"\n        - \"/swagger-resources/**\"\n        - \"/v2/api-docs\"\n        - \"/favicon.ico\"\n        - \"/user/**\"\nserver:\n  port: 8110  \n#启用knife4j增强模式\nknife4j:\n  enable: true\n  #生产模式屏蔽, true将禁止访问API在线文档, false可以看到文档, 密码失效\n  production: false\n  basic:\n    enable: true\n    username: root\n    password: root\nmybatis-plus:\n  configuration:\n    # 这个配置会将执行的sql打印出来，在开发或测试的时候可以用，不能输出到文件,假如需要输出到日志文件中那么 https://www.jb51.net/article/239936.htm\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl', '785fb9817c035b72def43440e9b8161e', '2010-05-05 00:00:00', '2022-12-29 18:34:22', NULL, '192.168.56.1', 'U', '764f9c7a-1874-4c91-985b-0678754a8208');
INSERT INTO `his_config_info` VALUES (23, 63, 'smile-sys-dev.yml', 'DEFAULT_GROUP', '', 'spring:\n  datasource:\n    type: com.zaxxer.hikari.HikariDataSource #springboot2.x之后默认\n    # serverTimezone=GMT%2B8 默认北京时区 useSSL=false 测试不用服务器的验证证书生产需要打开配置\n    url: jdbc:mysql://192.168.56.10:3306/smile_sys?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8&useSSL=false\n    username: root\n    password: 1qaz2wsx@!\n    # 8.0之后用cj\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    hikari:\n      #必须设置属性  maximum-pool-size  max-lifetime https://blog.csdn.net/michael_728/article/details/106914946\n      #连接池名字\n      pool-name: adminHikerPool\n      #最小空闲连接 此属性控制 HikariCP 尝试在池中维护的最小空闲连接数。 如果空闲连接低于此值并且池中的总连接数小于 maximumPoolSize，\n      #则 HikariCP 将尽最大努力快速有效地添加其他连接。 但是，为了获得最高性能和对峰值需求的响应，\n      #我们建议不要设置此值，而是允许 HikariCP 充当固定大小的连接池。 默认值：与 maximumPoolSize 相同 （一般配置和maximumPoolSize相同）\n      minimum-idle: 10\n      #此属性控制允许池到达的最大大小，包括空闲和正在使用的连接。 基本上，此值将确定数据库后端的最大实际连接数。\n      #对此的合理值最好由您的执行环境决定。 当池达到此大小，并且没有可用的空闲连接时，对 getConnection() 的调用将在超时前阻塞最多\n      #connectionTimeout 毫秒。 请阅读有关游泳池尺寸的信息。 默认值：10\n      maximum-pool-size: 10\n      #空闲连接存活最大时间，此属性控制允许连接在池中空闲的最长时间。 此设置仅在 minimumIdle 定义为小于maximumPoolSize 时适用。 一旦池达到 minimumIdle 连接，\n      #空闲连接将不会退出。 连接是否空闲退出的最大变化为 +30 秒，平均变化为 +15 秒。 在此超时之前，连接永远不会被空闲。\n      #值为 0 表示永远不会从池中删除空闲连接。 允许的最小值为 10000 毫秒（10秒）。 默认值：600000（10分钟） 一般不适用\n      idle-timeout: 600000\n      #此属性控制从池返回的连接的默认自动提交行为,默认值：true\n      auto-commit: true\n      #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟 此属性控制池中连接的最长生命周期。 使用中的连接永远不会退役，\n      #只有当它关闭时才会被删除。 在逐个连接的基础上，应用轻微的负衰减以避免池中的大量灭绝。 我们强烈建议设置此值，它应比任何数据库\n      #或基础结构强加的连接时间限制短几秒。 值 0 表示没有最大生命周期（无限生命周期），当然主题是 idleTimeout 设置。 默认值：1800000（30分钟）\n      max-lifetime: 1800000\n      #数据库连接超时时间  此属性控制客户端（即您）等待池中连接的最大毫秒数。 如果在没有连接可用的情况下超过此时间，则将抛出 SQLException。\n      #最低可接受的连接超时为 250 毫秒。 默认值：30000（30秒）\n      connection-timeout: 30000\n  jackson:\n    default-property-inclusion: ALWAYS\n    \nsmile:\n  sys:\n    #配置白名单路径,专供admin模块服务\n    ignore:\n      check: \"1\"\n      urls:\n        - \"/actuator/**\"\n        - \"/doc.html\"\n        - \"/webjars/**\"\n        - \"/swagger-resources/**\"\n        - \"/v2/api-docs\"\n        - \"/favicon.ico\"\n        - \"/user/**\"\nserver:\n  port: 8110  \n#启用knife4j增强模式\nknife4j:\n  enable: true\n  #生产模式屏蔽, true将禁止访问API在线文档, false可以看到文档, 密码失效\n  #production: false\n  basic:\n    enable: true\n    username: root\n    password: root\nmybatis-plus:\n  configuration:\n    # 这个配置会将执行的sql打印出来，在开发或测试的时候可以用，不能输出到文件,假如需要输出到日志文件中那么 https://www.jb51.net/article/239936.htm\n    log-impl: org.apache.ibatis.logging.stdout.StdOutImpl', '449594b4995ee4a0db598c382f4b6cd3', '2010-05-05 00:00:00', '2022-12-29 18:34:52', NULL, '192.168.56.1', 'U', '764f9c7a-1874-4c91-985b-0678754a8208');
